...
/**
 *@创建人  lijun
 *@创建时间  2018/8/22 0022 下午 6:56
 *@描述  TODO:用户身份校验
 *@修改人和其它信息
 *@当前包名 yycg.base.filter
 *@本类名称 LoginInterceptor
 *@参数  
 *@对像函数方法体的封装 function
 *@返回值  
 */
public class LoginInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request,
		...
		//校验用户身份是否合法 TODO:打断点测试 重启 Debug
		...
		//TODO:抛出异常，异常代码106（此操作需要登录后进行） 拦截用户操作，跳转到登陆页面
		ResultUtil.throwExcepion(ResultUtil.createWarning(Config.MESSAGE, 106, null));
		
		return false;
	}

	//TODO:执行时机：进入action方法，在返回modelAndView之前执行
	...
	//TODO:执行时机:action方法执行完成，已经 返回modelAndView，执行。
